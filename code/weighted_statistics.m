...
text(2, adip_obese.mean, sprintf('   p=%.3f', pval_adip), 'color', 'r', 'fontsize', 16)
hold off;
xlim([0, 3])
ylim([0, 100])
xticks(0:3)
...
text(2, vegfr2_spr.mean, sprintf('   p=%.3f', pval_vegfr2), 'color', 'r', 'fontsize', 16)
hold off;
xlim([0, 3])
ylim([1e-1, 1e3])
xticks(0:3)
...
a = axes('position',get(gca,'position'),'visible','off');
set(gca, 'fontsize', 18);
lgd2 = legend(a, [spr1, spr2, spr3, spr4, spr5, spr6], ...
    {"Huang, 1998"; "Cunningham, 1999" + newline + "(pre-dimer)"; "Cunningham, 1999" + newline + "(monomer)"; "Mamer, 2020"; "Shobhan, 2023" + newline + "(unpublished)"; "Weighted average"}, ...
    'Location', 'eastoutside');
title(lgd2, "SPR")
...
text(2, nrp1_spr.mean, sprintf('   p=%.3f', pval_nrp1), 'color', 'r', 'fontsize', 16)
hold off;
xlim([0, 3])
ylim([1e-1, 1e3])
xticks(0:3)
