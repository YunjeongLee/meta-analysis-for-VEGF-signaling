...
# Forest plot -------------------------------------------------------------
# kon
png(file=sprintf("%s/forest_vegfr1vegf165_kon.png", results_path), width=1300, height=500, type='cairo')
...
dev.off()
png(file=sprintf("%s/forest_vegfr2vegf165_kon.png", results_path), width=1300, height=500, type='cairo')
...
# koff
png(file=sprintf("%s/forest_vegfr1vegf165_koff.png", results_path), width=1300, height=500, type='cairo')
